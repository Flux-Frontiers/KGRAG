...
## FIG. 1 — Conceptual Diagram: The Ontology-Determinism Principle
...
## FIG. 2 — Phase Diagram: Compilation Phase vs. Query Phase
...
## FIG. 3 — Data Structure Diagram: Stable Node Addressing Scheme
...
## FIG. 5 — Comparison Diagram: Needle-in-a-Haystack Problem and Structural Traversal Solution
...
## FIG. 7 — Flow Diagram: Three-Pass AST Compiler for Python Source Code
