...
> - **Generated:** 2026-03-14T14:54:43Z  
> - **Version:** code-kg 0.8.1  
> - **Commit:** 1b28f6a (claude/kgrag-impact-product-kGJ2Q)  
> - **Platform:** Linux x86_64 | Python 3.12.3  
> - **Graph:** 1567 nodes · 1858 edges (130 meaningful)  
...
**Generated:** 2026-03-14 14:54:43 UTC
...
|------|-------|------|------|--------|
| 1 | 0.001735 | method | `KGRegistry._row_to_entry` | src/kg_rag/registry.py |
| 2 | 0.001468 | method | `CodeKGAdapter._load` | src/kg_rag/adapters/codekg_adapter.py |
| 3 | 0.001314 | method | `KGRegistry.list` | src/kg_rag/registry.py |
| 4 | 0.001231 | method | `KGRAG._get_adapter` | src/kg_rag/orchestrator.py |
| 5 | 0.001152 | function | `_load_kgrag` | src/kg_rag/app.py |
| 6 | 0.001146 | method | `DocKGAdapter._load` | src/kg_rag/adapters/dockg_adapter.py |
| 7 | 0.001110 | method | `KGRegistry.close` | src/kg_rag/registry.py |
| 8 | 0.001110 | method | `KGRAG.close` | src/kg_rag/orchestrator.py |
| 9 | 0.001110 | method | `MetaKGAdapter.is_available` | src/kg_rag/adapters/metakg_adapter.py |
| 10 | 0.000976 | method | `KGRAG._resolve_entries` | src/kg_rag/orchestrator.py |
| 11 | 0.000873 | method | `MetaKGAdapter._load` | src/kg_rag/adapters/metakg_adapter.py |
| 12 | 0.000855 | function | `_make_server` | src/kg_rag/mcp_server.py |
| 13 | 0.000841 | function | `_load_toml` | src/kg_rag/config.py |
| 14 | 0.000804 | method | `KGKind.from_str` | src/kg_rag/primitives.py |
| 15 | 0.000738 | function | `_parse_kinds` | src/kg_rag/cli/cmd_query.py |
| 16 | 0.000727 | method | `KGRegistry.register` | src/kg_rag/registry.py |
| 17 | 0.000727 | method | `KGRegistry.get` | src/kg_rag/registry.py |
| 18 | 0.000724 | method | `KGRegistry.find_by_name` | src/kg_rag/registry.py |
| 19 | 0.000713 | function | `default_registry_path` | src/kg_rag/registry.py |
| 20 | 0.000668 | function | `_init_state` | src/kg_rag/app.py |
...
| Rank | Score | Kind | Name | Module |
|------|-------|------|------|--------|
| 1 | 0.8341 | method | `KGRegistry._row_to_entry` | src/kg_rag/registry.py |
| 2 | 0.8107 | method | `CodeKGAdapter._load` | src/kg_rag/adapters/codekg_adapter.py |
| 3 | 0.7778 | method | `KGRegistry.close` | src/kg_rag/registry.py |
...
| Rank | Score | Kind | Name | Module |
|------|-------|------|------|--------|
| 1 | 0.827 | method | `CodeKGAdapter._load` | src/kg_rag/adapters/codekg_adapter.py |
| 2 | 0.7985 | method | `DocKGAdapter._load` | src/kg_rag/adapters/dockg_adapter.py |
| 3 | 0.7761 | method | `MetaKGAdapter._load` | src/kg_rag/adapters/metakg_adapter.py |
| 4 | 0.7525 | function | `_init_state` | src/kg_rag/app.py |
...
| Rank | Score | Kind | Name | Module |
|------|-------|------|------|--------|
| 1 | 0.7813 | method | `MetaKGAdapter.is_available` | src/kg_rag/adapters/metakg_adapter.py |
...
| 2 | 0.7133 | function | `_tab_query` | src/kg_rag/app.py |
| 3 | 0.7121 | function | `_parse_kinds` | src/kg_rag/cli/cmd_query.py |
...
| 3 | 0.7284 | function | `_tab_snippets` | src/kg_rag/app.py |
...
*Report generated by CodeKG Thorough Analysis Tool — analysis completed in 9.6s*
